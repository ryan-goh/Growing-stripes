function [UU] = sprof(x,y,cc,znew,pl)
...
figure(1)
box on
set(gcf, 'Position', [400, 400, 900, 400]);
...
imagesc(x,y,UI)
  ...
  %  set(xaxis,'FontSize',20)
    ...
    title(['$w$'],'Interpreter', 'latex', 'FontSize', 20,'Position',[130 5]);
subplot(3,1,2)
imagesc(x,y,VI)
    %xaxis=xlabel('$x$', 'Interpreter', 'latex', 'FontSize', 20);
    yaxis=ylabel('$y$', 'Interpreter', 'latex', 'FontSize', 20);
    ...
    %set(xaxis,'FontSize',20)
    set(yaxis,'FontSize',20)
    title(['$\chi_- u_p$'],'Interpreter', 'latex', 'FontSize', 20,'Position',[131 5]);
subplot(3,1,3)
imagesc(x,y,UU)
    xaxis=xlabel('$x$', 'Interpreter', 'latex', 'FontSize', 20);
    yaxis=ylabel('$y$', 'Interpreter', 'latex', 'FontSize', 20);
    ...
    set(xaxis,'FontSize',20)
    set(yaxis,'FontSize',20)
     title(['$w + \chi_- u_p$'],'Interpreter', 'latex', 'FontSize', 20,'Position',[133.5 5]);
    drawnow
