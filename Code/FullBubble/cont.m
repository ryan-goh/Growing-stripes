...
function [KDAT,dxx,dyy,Lx,Ly] = cont(dtcont,cc,PROF_I)
...
mu0 = 0.25;
tau=0;
plotbif = true;true; true;
plotprof =  true;false;true;
TIM =false;false;false; %time individual steps of continuation alg.
STEPS = 5000;
SAVE = true;true;
save_int = 2;
